...
pipeline {
    ...
    environment {
        channel='C04BPL2A5E3'
        NEXUS_PASSWORD     = credentials('token_lab_4')
    }
    stages {
            ...
            steps {
                script{
                    checkout(
                            ...
                            userRemoteConfigs: [[url: 'https://github.com/dobenna/ejemplo-maven-ceres.git']]])
                }
            }
        }
                ...
                script{
                    sh "echo 'Análisis Estático!'"
                        withSonarQubeEnv('sonarqube') {
                            ...
                            sh './mvnw clean verify sonar:sonar -Dsonar.projectKey=Lab_Mod_4-full-stages -Dsonar.projectName=Lab_Mod_4-full-stages -Dsonar.java.binaries=build'
                        }
        ...
        stage("Paso 6: Descargar Nexus"){
            steps {
                script{
                    sh ' curl -X GET -u admin:$NEXUS_PASSWORD "http://nexus:8081/repository/Repo_lab_mod4/com/devopsusach2020/DevOpsUsach2020/0.0.1/DevOpsUsach2020-0.0.1.jar" -O'
                }
            }
        }
